...
from tfx.components.base.base_executor import EmptyExecutor
...
class DummyExecutor(BaseExecutor):
    def Do(self, input_dict: Dict[Text, List[Artifact]],
        ...
        print('I am a dummy')
        absl.logging.debug('I am a DummyExecutor')
""" 
        for k, v in input_dict.items():
            absl.logging.debug(k)
            for a in v:
                absl.logging.debug(a)
...
_tfx_root = os.path.join(os.environ['HOME'], 'tfx_pipeline')
...
if __name__ == '__main__':
  ...
  pipeline._set_dummy('CsvExampleGen', DummyExecutor)
